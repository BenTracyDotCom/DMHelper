      ...
      <View>
       ...
       <TextInput 
         ...
         <View style={styles.buttonbar}>
           ...
           <TouchableOpacity style={{...styles.button, backgroundColor:'green'}} onPress={handleAddNote}>
            <Text>+</Text>
           </TouchableOpacity>
         </View>
         <TouchableOpacity className="h-[30px] mt-10" onPress={handleSubmit}>
          <Text>{`Add character to ${campaignName ? campaignName : 'new campaign'}`}</Text>
         </TouchableOpacity>
