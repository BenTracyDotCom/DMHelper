...
export default function NewCampaign() {
  ...
  return (
    ...
    >
      ...
      />
      {!!newCampaign.campaign.characters.length &&
        newCampaign.campaign.characters.map((char, i) => (
      ...
      <View style={styles.inputRow}>
        ...
        <TextInput placeholder="E.g. 'Meet X in Y'" onChangeText={setHook} />
      </View>
      <View style={styles.inputRow}>
        <Text style={styles.inputLabel}>First objective:</Text>
        <TextInput placeholder="E.g. Travel to Y" onChangeText={setObjective} />
      </View>
