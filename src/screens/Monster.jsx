    ...
    <ScrollView style={styles.container}>
      <View style={styles.box}>
        ...
        <View style={styles.attributeContainer}>
          <View style={styles.attributeBox}>
            <Text style={styles.attributeText}>Str: {monster.strength}</Text>
          </View>
          <View style={styles.attributeBox}>
            <Text style={styles.attributeText}>Dex: {monster.dexterity}</Text>
          </View>
          <View style={styles.attributeBox}>
          ...
          <View style={styles.attributeBox}>
            <Text style={styles.attributeText}>Wis: {monster.wisdom}</Text>
          </View>
          <View style={styles.attributeBox}>
            <Text style={styles.attributeText}>Cha: {monster.charisma}</Text>
          </View>
        </View>
      ...
      <View style={styles.box}>
        ...
        {monster.special_abilities &&
          monster.special_abilities.map((action, index) => (
