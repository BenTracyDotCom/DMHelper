  ...
  return (
    <ScrollView style={styles.scrollContainer}>
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.description}>{`${spellData.desc
        ...
        <View style={styles.group}>
          ...
          >{`Components: ${spellData.components.join(", ")}`}</Text>
          <Text
            style={styles.details}
          >{`Duration: ${spellData.duration}`}</Text>
          <Text style={styles.details}>{`Ritual: ${
            spellData.ritual ? "Yes" : "No"
          }`}</Text>
          <Text
            style={styles.details}
          >{`Casting Time: ${spellData.casting_time}`}</Text>
        </View>
        <View style={styles.group}>
          ...
          <View style={styles.group}>
            ...
            {Object.entries(spellData.damage.damage_at_slot_level).map(
              ([level, damage]) => (
                <Text
                  key={level}
                  style={styles.details}
                >{`Level ${level}: ${damage}`}</Text>
              ),
            )}
          </View>
        </View>
        <View style={styles.group}>
          <Text style={styles.details}>
            {" "}
            {`Classes: ${spellData.classes.map((cl) => cl.name).join(", ")}`}
          </Text>
          <Text style={styles.details}>
            {" "}
